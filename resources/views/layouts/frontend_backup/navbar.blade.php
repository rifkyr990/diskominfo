<div class="clever-main-menu">
    <div class="classy-nav-container breakpoint-off">
        ...
        <nav class="classy-navbar justify-content-between" id="cleverNav">
            ...
            <!-- Logo -->
            <a class="nav-brand" href="/"><img src="{{ asset('img/icons') }}/laravel.jpg" width="50" alt=""> CABANGBUNGIN</a>
            ...
            <div class="classy-menu">
                ...
                <div class="classynav">
                    <ul>
                        ...
                        <li><a href="{{ ('agenda')}}" class="{{ Request::is('agenda') ? 'text-primary' : '' }}">Agenda</a></li>
                    </ul>
