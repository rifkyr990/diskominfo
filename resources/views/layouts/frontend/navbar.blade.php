<nav class="navbar navbar-expand-lg fixed-top" style="background-color:green !important">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="{{asset('img/brand/favicon.png')}}" width="30">
        </a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('structure') }}">Struktur
                                Organisasi</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item"
                                href="{{ route('informasisetiapsaat') }}">Informasi Setiap Saat</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ route('informasiberkala') }}">Informasi
                                Secara Berkala </a></li>
