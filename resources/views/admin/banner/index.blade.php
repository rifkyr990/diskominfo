        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <tr>
                 ...
                 {{-- <td> <img src="asset{{ storage_path().'/storage/banner'.$art->image }}" alt="" title=""></a></td> --}}
                 <td class="text-center"><img src="{{asset('storage/banner/'.$art->image)}}" width="50" height="auto"/>
                  ...
                  <td class="text-center">
                    <center><div class="row ml-2" >
                        ...
                        <form method="POST" action="{{ route('admin.banner.destroy',$art->id) }}">
                            @csrf
                            @method('DELETE')
